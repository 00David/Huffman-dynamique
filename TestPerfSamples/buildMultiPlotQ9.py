...
# Exemple de données
tailles = [0, 1002, 5041, 10074]  # X-axis
labels_x = ["0","~1k", "~5k", "~10k"]  # Labels personnalisés
temps_comp = [0,32.748, 165.142,325.259]
temps_decomp = [0,31.035, 155.511, 319.351]
...
axes[0].set_title("Analyse des performances question 9")
axes[0].legend()
axes[0].grid(True)
